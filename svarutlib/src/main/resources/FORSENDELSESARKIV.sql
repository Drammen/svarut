...
CREATE TABLE "FORSENDELSESARKIV" ( ID VARCHAR(60) NOT NULL,
 FODSELSNR CHAR(11),
  ...
  ANT_SORT_HVIT_SIDER INTEGER,
  ANT_FARGE_SIDER INTEGER,
  ANT_ARK_KONVOLUTTERT_AUT INTEGER,
  ANT_EKS_ARK_KONVOLUTTERT_AUT INTEGER,
  ANT_ARK_KONVOLUTTERT_MAN INTEGER,
  ANT_EKS_ARK_KONVOLUTTERT_MAN INTEGER,
  VEKT INTEGER,
