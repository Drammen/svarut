...
public class AltinnAdministrationExternalFakeService extends HttpServlet {
	private static final long serialVersionUID = 1L;
	final static Logger logger = LoggerFactory.getLogger(AltinnAdministrationExternalFakeService.class);
